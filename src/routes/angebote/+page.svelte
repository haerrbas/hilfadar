<script>
  const angebote = [
    { id: 1, titel: "Einkauf erledigen", nutzer: "Anna", skills: ["Einkaufen"], karma: 12 },
    { id: 2, titel: "Paket annehmen", nutzer: "Ben", skills: ["Verfügbar"], karma: 8 },
    { id: 3, titel: "Hund spazieren führen", nutzer: "Sara", skills: ["Tiere"], karma: 20 },
  ];
</script>
...
<style>
  ...
  h2 { margin: 0.3rem 0 0.8rem; }
  .skills { display: flex; gap: 0.5rem; flex-wrap: wrap; margin-bottom: 1rem; }
